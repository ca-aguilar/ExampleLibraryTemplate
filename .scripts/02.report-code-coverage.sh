...
$LLVMCOV_PATH export -format=lcov -instr-profile=$CODECOV_PROFDATA_PATH $PACKAGE_TESTS_PATH -ignore-filename-regex=".build|Tests" Sources/LibraryTemplate > $LCOV_INFO_PATH
...
$LLVMCOV_PATH report -instr-profile=$CODECOV_PROFDATA_PATH $PACKAGE_TESTS_PATH -ignore-filename-regex=".build|Tests" Sources/LibraryTemplate --use-color=false
